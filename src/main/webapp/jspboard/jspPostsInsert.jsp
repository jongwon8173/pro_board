...
$(document).ready(function() {
	...
	$("#btnAddFile").on("click", function() {
		var fileLen = $("div#fileDiv input[name=file_upnm]").size();
		if(fileLen == 5) {
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<form  id="frm" action="/jspPostsInsert" method="POST" enctype="multipart/form-data">
					
					<input type="hidden" name="board_no" id="board_no" value="${jspPostsVo.board_no}" />
					<input type="hidden" name="posts_pno" id="board_no" value="${jspPostsVo.posts_pno}" />	<!-- 상위게시글ID -->
					<input type="hidden" name="posts_wri" id="posts_wri" value="${jspPostsVo.posts_wri}" />
	
					<div class="row" style="text-align: left;">
						<div class="col-sm-8 blog-main">
						<h2 class="sub-header">게시글 신규 등록</h2>
							<div class="table-responsive">
								
								<div class="form-group">
									<label for="posts_tit" class="col-sm-2 control-label">제 목</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" id="posts_tit" name="posts_tit" placeholder="게시글 제목">
									</div>
								</div>
								...
								<div class="form-group"> 
									...
									<div class="col-sm-10">
<textarea class="form-control" id="posts_con" name="posts_con" cols="80" rows="10">
${empty jspPostsVo.posts_con ? '' : jspPostsVo.posts_con}
</textarea>
									</div>
								</div>
								...
								<div class="form-group">  <!-- 첨부파일 테이블이용   -->
									...
									<div class="col-sm-8" id="fileDiv">
										<input type="file" id="file_upnm" name="file_upnm" /> 
									</div>
							...
							<a class="btn btn-default pull-right" id="btnInsert">저장</a>
